...
class UsuarioController extends AbstractController
{
     ...
     *
     * @Route("/sistema/usuarios/{id}/unsubscribe",
     *      name="app_usuario_unsubscribe",
     *      methods={"GET","POST"})
     */
    public function unsubscribe(Request $request, Usuario $usuario): Response
    {
     ...
     *
     * @Route("/sistema/usuarios/{id}/subscribe",
     *      name="app_usuario_subscribe",
     *      methods={"GET"})
     */
    public function subscribe(Usuario $usuario): Response
    {
        $usuario->setIsActive(true);
