 ...
 * @UniqueEntity(fields={"ci"}, message="CI en uso!.", groups={"registration"})
 * @UniqueEntity(fields={"username"}, message="Nombre de usuario en uso!.", groups={"registration"})
 * @UniqueEntity(fields={"correo"}, message="Cuenta de correo en uso!.", groups={"registration"})
 */
class Usuario implements UserInterface
{
     ...
     * @Assert\Regex(
     *     pattern     = "/^[a-zA-ZñáéíóúÑÁÉÍÓÚ ]+$/i",
     *     htmlPattern = "^[a-zA-ZñáéíóúÑÁÉÍÓÚ  ]+$",
     *     message="Este valor no es válido."
     * )
     */
    private $nombre;
    ...
    /**
     * @ORM\Column(name="servicios", type="json", nullable=true)
     */
